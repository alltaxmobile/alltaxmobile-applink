...
- 결제수단 관리: `https://app.alltaxmobile.co.kr/payment-methods`
- 지원사업 상세: `https://app.alltaxmobile.co.kr/employedcenter/{id}`

`/open` fallback 페이지를 사용하는 경우에도 같은 화면을 열 수 있습니다.

- `https://app.alltaxmobile.co.kr/open?screen=membership`
- `https://app.alltaxmobile.co.kr/open?screen=payment-methods`
- `https://app.alltaxmobile.co.kr/open?screen=employedcenter&id={id}`
