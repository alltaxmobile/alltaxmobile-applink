...
### 3. Universal Link 도메인

`/open/index.html`의 아래 도메인을 실제 연결 도메인으로 유지 또는 변경하세요.

- `https://link.alltaxmobile.co.kr`

### 4. 스토어 URL

아래 값이 실제 운영 링크와 맞는지 확인하세요.

- App Store: `https://apps.apple.com/us/app/id6529523756`
